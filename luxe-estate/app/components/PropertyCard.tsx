...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <article className="group relative h-full overflow-hidden rounded-xl bg-white shadow-card transition-all duration-300 hover:shadow-soft dark:bg-white/5">
      <Link
      ...
      <button
        ...
        className="absolute top-3 right-3 z-10 p-2 bg-white/90 dark:bg-black/50 rounded-full hover:bg-mosque hover:text-white transition-colors text-nordic-dark"
      >
